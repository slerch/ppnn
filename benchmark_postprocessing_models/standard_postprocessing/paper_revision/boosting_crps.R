## requires recent development version of crch package: install via
...
boosting_local_alldata_crps <- df_out
save(boosting_local_alldata_crps,
     file = "/home/sebastian/Projects/PP_NN/code/results/Rdata_files/boosting_local_2007-15_crps.Rdata")
