...
Rdata_dir <- "/media/sebastian/Elements/Postproc_NN/model_data/boosting/alldata/"
...
savenames <- paste0(Rdata_dir,
                    "alldata_boosting_global_maxit", pars$maxit,
                    "_nu", pars$nu,
                    "_mstop-", pars$mstop,
                    "_link-", pars$link,
                    ".Rdata")
...
pdf("alldata_boosting_global_tuning.pdf", width = 2*5, height = 3*5, pointsize = 12)
...
savenames <- paste0(Rdata_dir,
                    "alldata_boosting_local_maxit", pars$maxit,
                    "_nu", pars$nu,
                    "_mstop-", pars$mstop,
                    "_link-", pars$link,
                    ".Rdata")
...
pdf("alldata_boosting_local_tuning.pdf", width = 2*5, height = 3*5, pointsize = 12)
grid.arrange(p11, p12, 
             p21, p22, 
             p31, p32, 
             nrow = 3, ncol = 2)
