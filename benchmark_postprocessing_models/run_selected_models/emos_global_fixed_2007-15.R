...
emos_global_fixed_alldata <- df_out
save(emos_global_fixed_alldata,
     file = "/home/sebastian/Projects/PP_NN/code/results/Rdata_files/emos_global_fixed_2007-15.Rdata")
